...
namespace Penmedia\Admin\Http\Controllers;
...
use Penmedia\Admin\Http\Models\ModuleFieldTypes;
use Penmedia\Admin\Http\Helpers\LAHelper;
...
class FieldController extends Controller
{
	...
	public function edit($id)
	{
		...
		return view('admin::modules.field_edit', [
			'module' => $module,
			'ftypes' => $ftypes,
			'tables' => $tables
		])->with('field', $field);
