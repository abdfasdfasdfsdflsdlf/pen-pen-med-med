...
<div id="headerwrap">
    <div class="container">
        <div class="row centered">
            <div class="col-lg-12">
                <h1>{{ Common::getByKey('sitename_part1') }} <b><a>{{ Common::getByKey('sitename_part2') }}</a></b></h1>
                <h3>{{ Common::getByKey('site_description') }}</h3>
...
<div id="footerwrap">
    <div class="container">
        <div class="col-lg-5">
            ...
            <p>
				Technostar Group,<br/>
				Web Development Company in Raipur,<br/>
                Raipur, Chhattisgarh, India - 492001
            </p>
			<div class="contact-link"><i class="fa fa-envelope-o"></i> <a href="mailto:info@technostargroup.in">info@technostargroup.in</a></div>
			<div class="contact-link"><i class="fa fa-building"></i> <a href="http://www.technostargroup.in">www.technostargroup.in</a></div>
        </div>
