...
<body class="login-page">
    <div class="login-box">
        ...
        <div class="login-box-body">
            ...
            {!! Former::horizontal_open()->action('/password/email')->method('post') !!}
            {!! Former::token() !!}
                ...
                <div class="row">
                    <div class="col-xs-8 col-xs-offset-2">
                        <button type="submit" class="btn btn-primary btn-block btn-flat">@lang('penmedia\common::common.label.send-reset-link')</button>
                    </div>
                </div>
            {!! Former::close() !!}
